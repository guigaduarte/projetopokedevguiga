window.alert('bem vindo a pokedev de guiga')
...
listaSelecaoPokedevs.forEach(pokedev =>{
   pokedev.addEventListener("click", () =>{
      ...
      const idPokedeveSelecionado = mostrarCartaoPokedev(pokedev);

      
      desativarPokedevNaListagem();

   
      ativarPokedevSelecionadoNalistagem(idPokedeveSelecionado);
   
    })                                          
 })

function ativarPokedevSelecionadoNalistagem(idPokedeveSelecionado) {
    const pokedeveSelecionadoNaListagem = document.getElementById(idPokedeveSelecionado);
